...
def get_ds(config):
    ...
    # we only have "en-nl" but we want "nl" as source and "en" as target
    dataset_raw = load_dataset(f"{config['datasource']}", f"en-nl", split='train')
...
if __name__ == '__main__':
    ...
    config = get_config()
    config['model_folder'] = '/content/drive/MyDrive/nl2en/weights/'
    config['model_basename'] = 'tmodel_'
    config['tokenizer_file'] = '/content/drive/MyDrive/nl2en/vocab/tokenizer_{0}.json'
